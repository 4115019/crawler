...
public class FileCache extends FilePersistentBase implements Downloader, Pipeline, PageProcessor {
    ...
    public Page download(Request request, Site site, Task task) {
        ...
        if (page == null) {
            page = downloadWhenMiss(request, site);
        }
        return page;
    }
    ...
    public Page download(Request request, Site site) {
        throw new UnsupportedOperationException("not supported download operation");
    }
    ...
    private Page downloadWhenMiss(Request request, Site site) {
        Page page = null;
        if (downloaderWhenFileMiss != null) {
            page = downloaderWhenFileMiss.download(request, site);
        }
        return page;
    }
